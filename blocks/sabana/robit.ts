namespace bloques {
    // En EXT3 no están ultrasonido_logico.ts ni movimiento.ts, así que los
    // desplegables que usan estos bloques se definen aquí.
     ...
     *
     * En EXT3 este bloque está oculto del toolbox: solo aparece encajado
     * como shadow dentro del hexágono "detecta objeto" (ultrasonido_rgb_logico).
     */
